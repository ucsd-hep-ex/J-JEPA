...
class VisionTransformerPredictor(nn.Module):
    ...
    def forward(self, x, masks_x, masks):
        ...
        # -- prepare position embeddings for target tokens (specified by masks)
        # self.predictor_pos_embed: (1, num_patches, predictor_embed_dim)
        pos_embs = self.predictor_pos_embed.repeat(
            B, 1, 1
